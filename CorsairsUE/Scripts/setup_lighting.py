...
# Плотность тумана. Прежние 0.008 выбеливали кадр: на сверке этапа 1 доля
# тёплых пикселей была впятеро ниже эталона живого клиента, и вся сцена
# читалась молочной. Дымка оригинала едва заметна — оставлен минимум,
# достаточный для воздушной перспективы на дальнем плане.
FOG_DENSITY = 0.002
